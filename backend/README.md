...
Времена и эффекты — баланс прототипа, не норматив работы ВСМ. Старый
диалоговый API остаётся доступным до интеграции клиента. Таймер с последствиями
и причинный debrief добавляются следующим этапом.
